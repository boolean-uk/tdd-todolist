...
describe('TodoList', () => {
    ...
    it('should get only incomplete todo items', () => {
        ...
        expect(todoList.getIncompleteTodos()).toEqual([{ id: 1, description: 'Incomplete Todo', completed: false }]);
    });
    ...
    it('should get only complete todo items', () => {
        ...
        todoList.createTodo('Complete Todo');
        todoList.setTodoCompleted(2);
        expect(todoList.getCompleteTodos()).toEqual([{ id: 2, description: 'Complete Todo', completed: true }]);
    });

    it('should search and return a todo item by its ID', () => {
        todoList.createTodo('Find Me');
        expect(todoList.getTodoById(1)).toEqual({ id: 1, description: 'Find Me', completed: false });
    });
